...
function initializeGraph(settings) {
  ...
  async function listCalendars() {
    ...
    const calendarPage = await graphHelper.listCalendars();
    const calendars = calendarPage.value;
  ...
  async function sendCalendarEntry() {
    ...
    try {
        await graphHelper.sendCalendarEntry();
        console.log("New calendar entry send successfully!");
    } catch (err) {
      console.log(`Error making Graph call: ${err}`);
    }
  }
